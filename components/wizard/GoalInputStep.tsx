            ...
            <div className="w-full max-w-[800px] mx-auto px-4 animate-fade-in relative z-10 flex flex-col items-center justify-center pt-[10vh] pb-[5vh]" style={{ minHeight: 'calc(100vh - 260px)' }}>
                ...
                <div className="relative group w-full max-w-[720px]">
                    <textarea
                        ...
                        className="w-full min-h-[80px] sm:min-h-[88px] bg-[rgba(20,20,20,0.65)] backdrop-blur-[24px] border border-white/10 rounded-2xl p-5 pb-14 text-[14px] text-gray-200 placeholder-gray-500 resize-none outline-none focus:border-white/20 transition-all leading-relaxed shadow-xl"
                        maxLength={2000}
                        onKeyDown={(e) => {
                    ...
                    <div className="absolute bottom-4 left-4 right-4 flex justify-between items-center bg-transparent">
                        <button className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-white/10 text-gray-400 hover:text-white transition-colors">
                            <Plus strokeWidth={2} className="w-5 h-5" />
                        </button>

                        <div className="flex items-center gap-1 sm:gap-3">
                            {/* Plan Toggle */}
                            <div className="flex items-center gap-2 mr-1 sm:mr-3 border-r border-white/10 pr-3 sm:pr-5">
                                <span className="text-[13px] font-medium text-gray-300">Plan</span>
                            ...
                            <button
                                ...
                                className="w-8 h-8 ml-1 rounded-full bg-white flex items-center justify-center text-black disabled:opacity-30 disabled:bg-gray-500/50 disabled:text-gray-400 hover:scale-105 active:scale-95 transition-all shadow-[0_0_15px_rgba(255,255,255,0.2)] disabled:shadow-none"
                            >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        {RECENT_PROJECTS.map((item, i) => (
                            <div
                                ...
                                className="group flex flex-col bg-[rgba(15,15,15,0.7)] backdrop-blur-md border border-white/5 rounded-2xl overflow-hidden hover:-translate-y-1 transition-all duration-300 cursor-pointer shadow-lg hover:shadow-2xl hover:border-white/10"
                            >
                                ...
                                <div className="p-4 flex items-center gap-3">
                                    ...
                                    <div className="min-w-0">
                                        <h4 className="text-[13px] font-semibold text-gray-200 truncate group-hover:text-white transition-colors">{item.title}</h4>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {savedProjects.length === 0 && (
                            <div className="sm:col-span-2 lg:col-span-3 flex flex-col items-center justify-center py-16 text-center">
                                <Coins className="w-14 h-14 text-gray-600 mb-4" strokeWidth={1} />
                                <h4 className="text-[15px] font-semibold text-gray-300 mb-1">No tokens yet</h4>
                                <p className="text-[13px] text-gray-500 max-w-sm">Create your first token using the AI prompt above. It will appear here once deployed.</p>
                            </div>
                        )}
                            ...
                            >
                                ...
                                <div className="p-4 flex items-center justify-between">
                                    <div className="flex items-center gap-3 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                            <h4 className="text-[13px] font-semibold text-gray-200 truncate group-hover:text-white transition-colors">{project.tokenName}</h4>
                                            <p className="text-[11px] text-gray-500 mt-0.5">{formatTimeAgo(project.createdAt)}</p>
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            className="group flex flex-col items-center justify-center bg-[rgba(15,15,15,0.4)] backdrop-blur-md border border-dashed border-white/10 rounded-2xl overflow-hidden hover:-translate-y-1 transition-all duration-300 cursor-pointer shadow-lg hover:shadow-2xl hover:border-[#22D3EE]/30 min-h-[200px]"
                        >
                            <Plus className="w-10 h-10 text-gray-500 group-hover:text-[#22D3EE] transition-colors mb-3" strokeWidth={1.5} />
                            <span className="text-[13px] font-medium text-gray-500 group-hover:text-white transition-colors">Create new project</span>
                        </div>
                    </div>
                )}
                            ...
                            >
                                ...
                                <div className="p-4">
                                    <div className="flex items-center justify-between mb-1">
                                        <h4 className="text-[13px] font-semibold text-gray-200 truncate group-hover:text-white transition-colors">{template.name}</h4>
                                    </div>
                                    <p className="text-[11px] text-gray-500 line-clamp-2 leading-relaxed">{template.description}</p>
                                    <div className="mt-3 flex items-center gap-2">
                                        <span className="text-[10px] font-bold tracking-wider uppercase px-2 py-0.5 rounded-full bg-[#22D3EE]/10 text-[#22D3EE] border border-[#22D3EE]/20">
                                            {template.category}
                                        </span>
