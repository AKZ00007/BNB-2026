...
const DEFAULT_GLOW_COLOR = '243, 186, 47'; // Default to BNB Yellow Instead of Purple
...
// Instead of passing rigid "cardData", we wrap existing children inside the MagicBento grid layout.
export const MagicBento: React.FC<BentoProps> = ({
    ...
    return (
        ...
        `}
            ...
            <div
                className="bento-section grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative"
                ref={gridRef}
            >
                {children}
            </div>
