            ...
            <div className="max-w-[1200px] mx-auto px-8 h-16 flex items-center justify-between">
                ...
                <Link href="/" className="flex items-center gap-2 group">
                    <div className="shrink-0">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="2" y="2" width="9" height="9" className="fill-gray-900 group-hover:fill-primary transition-colors" />
                            <rect x="13" y="2" width="9" height="9" className="fill-gray-900 group-hover:fill-primary transition-colors delay-75" />
                            <rect x="2" y="13" width="9" height="9" className="fill-gray-900 group-hover:fill-primary transition-colors delay-100" />
                            <rect x="13" y="13" width="9" height="9" className="fill-gray-900 group-hover:fill-primary transition-colors delay-150" />
                        </svg>
                    </div>
                    <span className="font-bold text-base text-gray-900">BNB Launchpad</span>
                </Link>
                ...
                <NavigationMenu.Root className="relative flex justify-center z-[1] hidden md:flex">
                    <NavigationMenu.List className="flex items-center gap-6 m-0 p-0 list-none">
                        <NavigationMenu.Item>
                            <NavigationMenu.Trigger className="flex items-center gap-1 font-medium text-[15px] text-gray-900 hover:text-primary transition-colors group">
                                Features
                        ...
                        <NavigationMenu.Item>
                            <Link href="/explorer" className="block text-[15px] font-medium text-gray-900 hover:text-primary transition-colors">
                                Explorer
                            </Link>
                        </NavigationMenu.Item>
                    </NavigationMenu.List>
                    ...
                    <div className="perspective-[2000px] absolute top-full left-1/2 -translate-x-1/2 flex justify-center">
                        <NavigationMenu.Viewport className="relative mt-2 h-[var(--radix-navigation-menu-viewport-height)] w-full origin-[top_center] overflow-hidden rounded-xl bg-white shadow-lg transition-[width,_height] duration-300 data-[state=closed]:animate-scale-out data-[state=open]:animate-scale-in sm:w-[var(--radix-navigation-menu-viewport-width)]" />
                    </div>
                </NavigationMenu.Root>

                {/* CTAs */}
                <div className="flex items-center gap-3">
                    <Link href="/login" className="border border-gray-200 rounded-full px-4 py-2 text-[14px] font-semibold text-gray-900 hover:bg-gray-50 transition-colors hidden sm:block">
                        Login
                    </Link>
